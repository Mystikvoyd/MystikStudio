...
$ConfigPath         = Join-Path $LoraTesterRoot "lora-tester.config.json"
$InvokeScriptPath   = Join-Path $ProjectRoot "Creators\comfyui\scripts\Invoke-ComfyLoraTestImage.ps1"
$PrefsPath   = Join-Path $LoraTesterRoot "lora-tester.prefs.json"
$RunLogPath  = Join-Path $LoraTesterRoot "lora-tester.runlog.json"
