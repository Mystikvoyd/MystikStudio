...
- Tickets are numbered sequentially: `MVS-000000001`, `MVS-00000000002`, ...
...
- **When a ticket is closed and the same issue reoccurs or needs continuation:**
  - Close the old ticket with `continued_in: MVS-NNNNNNNNN`
  - Create a NEW ticket (next sequential number) that starts with `continues: MVS-NNNNNNNNN`
